...
public class ScrollHelper {
	...
	public ScrollHelper(int scrollBarSize, String texture) {
		this(scrollBarSize, texture, null);
	}

	public ScrollHelper(int scrollBarSize, String texture, String bgTexture) {
	...
	public void drawScrollBar(int mouseX, int mouseY, float renderParticleTicks, final RenderEngine renderEngine) {
	...
	public void drawScrollBarBackGround(int mouseX, int mouseY, float renderParticleTicks,
		...
		SafetyGL.safetyGLProcess(new SafetyGL.Processor() {
			...
			public void process(SafetyGL safetyGL) {
				GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
				safetyGL.disableStandardItemLighting();
				renderEngine.bindTexture(bgTexture);
